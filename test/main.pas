...
type
  ...
  published
    ...
    procedure TestUniDWord;
    procedure TestUniLongInt;
    procedure TestUniQWord;
    procedure TestUniInt64;
  end;
...
begin
  s := '';
  AssertEquals('empty string', False, TryDgsChars2Int(s[1..Length(s)], '_', d));
  s := '_0';
  AssertEquals('convert "_0"', False, TryDgsChars2Int(s[1..Length(s)], '_', d));
  s := '0_';
  d := 42;
  AssertEquals('convert "0_"', True, TryDgsChars2Int(s[1..Length(s)], '_', d));
  AssertEquals('convert "0_", result', 0,  d);
  s := '-1_0';
  AssertEquals('convert "-1_0"', False, TryDgsChars2Int(s[1..Length(s)], '_', d));
  s := '10';
  AssertEquals('use "#9" as separator', False, TryDgsChars2Int(s[1..Length(s)], #9, d));
  d := 42;
  s := '  '#9#9'0';
  AssertEquals('convert "  #9#90"', True, TryDgsChars2Int(s[1..Length(s)], '_', d));
  AssertEquals('convert "  #9#90", result', 0, d);
  s := '1_0';
  AssertEquals('convert "1_0"', True, TryDgsChars2Int(s[1..Length(s)], '_', d));
  AssertEquals('convert "1_0", result', 10, d);
  s := ' '#9'+4_000_000_000_';
  AssertEquals('convert " #9+4_000_000_000_"', True, TryDgsChars2Int(s[1..Length(s)], '_', d));
  AssertEquals('convert " #9+4_000_000_000", result', 4000000000, d);
  s := '4__294__96__729__5__';
  AssertEquals('convert "4__294__96__729__5__"', True, TryDgsChars2Int(s[1..Length(s)], '_', d));
  AssertEquals('convert "4__294__96__729__5__", result', 4294967295, d);
  s := '4__294__96__7b9__5';
  AssertEquals('convert "4__294__96__7b9__5"', False, TryDgsChars2Int(s[1..Length(s)], '_', d));
  s := '4__294__96__729__6__';
  AssertEquals('convert "4__294__96__729__5__6"', False, TryDgsChars2Int(s[1..Length(s)], '_', d));
end;
...
begin
  s := '';
  AssertEquals('empty string', False, TryDgsChars2Int(s[1..Length(s)], '_', i));
  s := '_0';
  AssertEquals('convert "_0"', False, TryDgsChars2Int(s[1..Length(s)], '_', i));
  s := '0_';
  i := 42;
  AssertEquals('convert "0_"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
  AssertEquals('convert "0_", result', 0,  i);
  s := '+0';
  AssertEquals('use "#9" as separator', False, TryDgsChars2Int(s[1..Length(s)], #9, i));
  i := 42;
  s := '  '#9#9'-0';
  AssertEquals('convert "  #9#9-0"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
  AssertEquals('convert "  #9#90", result', 0, i);
  s := '-1_0';
  AssertEquals('convert "-1_0"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
  AssertEquals('convert "-1_0", result', -10, i);
  s := '2_147_483_647_';
  AssertEquals('convert "2_147_483_647_"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
  AssertEquals('convert "2_147_483_647_", result', 2147483647, i);
  s := '2_147_483_648_';
  AssertEquals('convert "2_147_483_648_"', False, TryDgsChars2Int(s[1..Length(s)], '_', i));
  s := ' -2_147_483_648_';
  AssertEquals('convert "-2_147_483_648_"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
...
begin
  s := '';
  AssertEquals('empty string', False, TryDgsChars2Int(s[1..Length(s)], '_', q));
  s := '_0';
  AssertEquals('convert "_0"', False, TryDgsChars2Int(s[1..Length(s)], '_', q));
  s := '0_';
  q := 42;
  AssertEquals('convert "0_"', True, TryDgsChars2Int(s[1..Length(s)], '_', q));
  AssertEquals('convert "0_", result', 0,  q);
  s := '-1_0';
  AssertEquals('convert "-1_0"', False, TryDgsChars2Int(s[1..Length(s)], '_', q));
  s := '10';
  AssertEquals('use "#9" as separator', False, TryDgsChars2Int(s[1..Length(s)], #9, q));
  q := 42;
  s := '  '#9#9'0';
  AssertEquals('convert "  #9#90"', True, TryDgsChars2Int(s[1..Length(s)], '_', q));
  AssertEquals('convert "  #9#90", result', 0, q);
  s := '1_0';
  AssertEquals('convert "1_0"', True, TryDgsChars2Int(s[1..Length(s)], '_', q));
  AssertEquals('convert "1_0", result', 10, q);
  s := ' '#9'+18__44__67__440__737__09__551__615_';
  AssertEquals('convert " #9+18__44__67__440__737__09__551__615_"', True, TryDgsChars2Int(s[1..Length(s)], '_', q));
  AssertEquals('convert " #9+18__44__67__440__737__09__551__615_", result', 18446744073709551615, q);
  s := '18_446_744_0e3_709_551_616';
  AssertEquals('convert "18_446_744_0e3_709_551_616"', False, TryDgsChars2Int(s[1..Length(s)], '_', q));
  s := '18_446_744_073_709_551_616';
  AssertEquals('convert "18_446_744_073_709_551_616"', False, TryDgsChars2Int(s[1..Length(s)], '_', q));
end;
...
begin
  ...
  AssertEquals('convert "9_223_372_036_____854_775_807"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
  AssertEquals('convert "9_223_372_036_____854_775_807", result', 9223372036854775807, i);
  s := '9_223_372_036_854_775_808';
  AssertEquals('convert "9_223_372_036_854_775_808"', False, TryDgsChars2Int(s[1..Length(s)], '_', i));
  s := ' -9_223_372_036_854_775_808';
  AssertEquals('convert " -9_223_372_036_854_775_808"', True, TryDgsChars2Int(s[1..Length(s)], '_', i));
  AssertEquals('convert " -9_223_372_036_854_775_808", result', -9223372036854775808, i);
  s := '-9_223_372_036_854_775_809';
  AssertEquals('convert "-9_223_372_036_854_775_809"', False, TryDgsChars2Int(s[1..Length(s)], '_', i));
end;
...
procedure TTestS2I.TestUniDWord;
var
  s: unicodestring;
  d: DWord;
begin
...
procedure TTestS2I.TestUniLongInt;
var
  s: unicodestring;
  i: LongInt;
begin
...
procedure TTestS2I.TestUniQWord;
var
  s: unicodestring;
  q: QWord;
begin
...
procedure TTestS2I.TestUniInt64;
var
  s: unicodestring;
  i: Int64;
begin
